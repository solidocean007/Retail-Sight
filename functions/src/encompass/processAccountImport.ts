...
export const processAccountImport = onRequest(async (req, res) => {
  ...
  try {
    ...
    console.log("RAW EMAIL PREVIEW:", rawEmail.slice(0, 1500));
    ...
    console.log("Loaded sync config:", syncConfig);
    ...
    const diffs = getAccountDiffs(normalized, existingAccounts);
    ...
    const diffHash = JSON.stringify(diffs);
