...
export const { setReduxAccounts, clearReduxAccounts } = userAccountsSlice.actions;
export const selectUserAccounts = (state: RootState) => state.userAccounts.accounts; // 'state.userAccounts' is of type 'unknown'
export const selectUserAccountsLoading = (state: RootState) => state.userAccounts.loading; // 'state.userAccounts' is of type 'unknown'.
