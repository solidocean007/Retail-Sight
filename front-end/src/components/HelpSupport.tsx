   ...
   <HelpSupportHelmet />
     <div className="help-support-container">
      ...
      <section>
        ...
        <p>Find answers to the most common questions about Displaygram.com.</p>
        {/* Assuming you would have a link to a FAQ page or expandable sections here */}
      </section>
      <section>
        <h2>Customer Support</h2>
        <p>
          Need more help? Our customer support team is available Monday to Friday from 9am to 5pm (your timezone).
          You can reach us at:
        </p>
        <ul>
      ...
      <section>
        ...
        <p>
          If you are experiencing technical issues, please contact our technical support team at:
        </p>
        <ul>
