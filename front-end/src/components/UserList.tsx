            ...
            <tr key={user.uid}>
              <td>
                <input
                  ...
                  onChange={(e) =>
                    handleEditChange(user.uid, "firstName", e.target.value)
                  }
                />
                <input
                  type="text"
                  value={user.lastName}
                  onChange={(e) =>
                    handleEditChange(user.uid, "lastName", e.target.value)
                  }
                />
              </td>
              <td>
                <input
                  ...
                  value={user.email}
                  onChange={(e) =>
                    handleEditChange(user.uid, "email", e.target.value)
                  }
                />
              </td>
              <td>
              ...
              <td>
                <button onClick={() => onEdit(user.uid, editedUsers[user.uid])}>
                  Save
                </button>
